        ...
        items: [
          {
            ...
            translatedLabel: ProjectStatus.ContractPending,
            value: ProjectStatus.ContractPending,
          },
          {
            id: "projectstatus-item-1",
            translatedLabel: ProjectStatus.Live,
            value: ProjectStatus.Live,
          },
          {
            id: "projectstatus-item-2",
            translatedLabel: ProjectStatus.IntroductionsOpen,
            value: ProjectStatus.IntroductionsOpen,
          },
          {
            id: "projectstatus-item-3",
            translatedLabel: ProjectStatus.PreRegisterInterest,
            value: ProjectStatus.PreRegisterInterest,
          },
        ],
      },
    ],
...
const LiveProjects: NextPage = ({ query }: any) => {
  ...
  return (
    <Database
      ...
      filters={filters}
      data={list.map((item)=>({...item, country: intl.formatMessage({...countryList.find((li)=>li.value === item.country)?.label})}))}
